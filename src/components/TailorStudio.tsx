...
export function TailorStudio({
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 pb-20">
      ...
      {activeTab === "print" && (
        <div className="space-y-4">
          <div className="no-print flex items-center justify-between rounded-xl bg-neutral-100 p-4 dark:bg-neutral-800">
            <p className="text-xs text-neutral-600 dark:text-neutral-300">
              Detta är en ren, ATS-vänlig layout anpassad för A4-utskrift och export
              till PDF. Klicka på &quot;Skriv ut / Spara som PDF&quot; och välj &quot;Spara som
              PDF&quot; i utskriftsdialogen.
            </p>
            <button
              onClick={() => window.print()}
              className="flex items-center gap-2 rounded-lg bg-neutral-900 px-4 py-2 text-xs font-semibold text-white hover:bg-black dark:bg-white dark:text-black"
            >
              <Printer className="h-4 w-4" />
          ...
          <div className="mx-auto max-w-3xl rounded-xl border border-neutral-200 bg-white p-10 text-black shadow-md print:border-none print:p-0 print:shadow-none">
            ...
            <div className="border-b-2 border-neutral-900 pb-4">
              <h1 className="text-2xl font-bold uppercase tracking-tight">
                {masterProfile?.fullName || "Förnamn Efternamn"}
              </h1>
